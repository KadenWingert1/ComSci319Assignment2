...
import pocketKnives from "./images/pocketKnife.jpg";
import daggers from "./images/daggers.png";
import swords from "./images/swords.jfif"
import resinWork from "./images/resinWork.png";
...
<div className="h-screen bg-slate-800 p-3" style={{ minWidth:
'65%' }}>
<img className="w-full" src={logo} alt="Company logo" />
<div className="px-6 py-4">
<h1 className="text-3xl mb-2 font-bold text-white"> Browse Products
</h1>
<p className="text-gray-700 text-white">
<b>Kaden Wingert, Bryce Maloy</b>
</p>
<div className="py-10">
